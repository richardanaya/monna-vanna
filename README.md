...
This repository accumulates all production materials, character prompts, style guides, and shot planning for Richard Anaya's adaptation of the complete three-act play — no cuts, no rewrites, every line preserved.

The adaptation is structured as a trilogy of act-films:
- **Act I: The Price**
- **Act II: The Tent**
- **Act III: The Refusal**
...
- **[looks/](looks/)** — Character visual design lock
  - [characters.md](looks/characters.md) — Full paste-ready character prompts for all principals and supporting cast

- **[plan/](plan/)** — Narrative structure
...
The play text is in the **US public domain** (published 1904, pre-1931). Source: Alfred Sutro translation, George Allen London 1904.

Archive.org reference: https://archive.org/details/monnavanna00maetiala

This adaptation is a creative work by Richard Anaya. All original production materials © 2026.
