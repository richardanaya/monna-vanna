# Trilogy Structure & Production Plan

## Overview

*Monna Vanna* is adapted as a **trilogy of act-films**, preserving the complete three-act structure of Maeterlinck's play **word-for-word** from the Alfred Sutro 1904 translation.

**No cuts. No rewrites. No compression.**

Each act is a self-contained film chapter with its own dramatic arc, but all three acts tell one complete story.
...
## Word-for-Word Dialogue Rule

**Every line of dialogue from the Sutro 1904 translation must appear in the adaptation, uncut and unaltered.**

This includes:
- All principal dialogue (Giovanna, Guido, Marco, Prinzivalle, Trivulzio, Vedio, Borso, Torello)
- All stage directions that specify visible action
- All entrances and exits

**Permissible adaptations:**
- Voice-over for internal stage directions ("He pauses," "She turns away")
- Visual interpretation of stage directions (a "long pause" might be a 10-second held shot)
- Expanding silent moments with additional visual storytelling (a character walking to a window, Giovanna's hands trembling)

**Not permissible:**
- Cutting dialogue lines for pacing
- Paraphrasing or modernizing language
- Combining characters or scenes
- Adding invented dialogue

---

## Point of View & Moral Axis

**Giovanna is the moral axis of the story.**

While all three principal characters (Giovanna, Guido, Prinzivalle) are essential, **Giovanna's choice, sacrifice, and integrity** are the engine of the drama.
...
- Giovanna's hands, posture, and silence are as important as her words
- The camera respects her dignity — no male-gaze framing, no titillation

---

## Act-by-Act Beat Outline
...
## Three-Hander Intimacy

Though the play has a large cast, **it is fundamentally a three-hander:**

1. **Giovanna** — moral center, sacrificial figure, woman of agency
2. **Guido** — husband, commander, man destroyed by his own honor and jealousy
3. **Prinzivalle** — mercenary, friend, would-be lover, man of restraint and ambiguity

**Supporting cast (Marco, Trivulzio, Vedio, Borso, Torello, Seigniory elders) exist to pressure these three principals toward impossible choices.**

**The trilogy structure preserves this intimacy:**
- Act I: Giovanna chooses (with Guido and Marco as obstacles and witnesses)
- Act II: Giovanna and Prinzivalle alone (the moral test)
- Act III: Giovanna and Guido alone (the moral aftermath), Marco as witness
...
## Do Not Rewrite the Play

**This is not a "modern reimagining" or a "compressed adaptation."**

The goal is to **translate Maeterlinck's complete text into visual form**, respecting:
- The 1904 language and phrasing (formal, poetic, deliberate)
- The three-act structure (no merging acts or cutting scenes)
- The moral ambiguity (no imposed modern interpretations)
- The historical texture (late 15th-century Tuscany, not generic medievalism)

**Every shot serves the text. Every image serves the drama.**

If a scene feels slow or talky on the page, the solution is **visual layering** (hands, faces, light, architecture), not cutting dialogue.

---

## Tempera Chronicle Integration

All shots follow the **Tempera Chronicle style lock** from `docs/style-tempera-chronicle.md`:

- Stylized, not photoreal
- Renaissance fresco-influenced
- Ochre limestone iron-grey torch-amber palette
- Hard directional painted light
- Dignified moral clarity

**No modern photography tropes. No romantasy glow. No photorealistic skin.**

Each frame is a **painted history panel** — cinema as moving illustration.

---

## Production Workflow

1. **Script lock per act** (Sutro 1904 dialogue formatted for film)
2. **Shot breakdown** (scene-by-scene, with character and setting prompts)
3. **Seedance 2 generation** (using locked character prompts from `looks/characters.md` + style suffix)
4. **Frame review & iteration** (director approval, style consistency checks)
5. **Assembly & editing** (once all frames are generated, acts are assembled as film chapters)

**This repo is the master accumulation point for all materials.**

Shot lists, prompts, and generated frames will be committed here as production progresses.
